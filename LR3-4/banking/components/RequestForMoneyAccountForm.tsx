...
export const RequestForMoneyAccountForm = (props: RequestForMoneyAccountFormProps) => {
  ...
  return (
    <form className="flex flex-col w-2/3 max-md:w-full gap-y-5">
      ...
      <LabeledInput type="text" label="Full name" disabled value={props.userData.last_name + ' ' + props.userData.first_name + ' ' + props.userData.middle_name}/>
      ...
      <div className="flex flex-col">
        ...
        <Select values={currencyNames} selectedLabel={currencyTitle} onChange={setCurrencyTitle} className="mr-auto max-md:w-full w-2/3" />
      </div>
