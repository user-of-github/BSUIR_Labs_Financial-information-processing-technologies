...
export const Input = <InputValueType extends SupportedInputValueType>({
  ...
  return (
    <input
      type={type}
      className={clsx(
        'block w-full disabled:select-none disabled:opacity-30 rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:outline-blue-500 focus:ring-blue-500 disabled:pointer-events-none dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500',
        className
      )}
